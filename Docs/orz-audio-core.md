...
不阻塞 OrzMusic 当前功能的 SDK 独立发布增强项，已拆分到 [OrzAudioCore 后续任务清单](backlog/orz-audio-core-backlog.md)。这些任务可逐项交给 5.5 轻度模型推进，主要覆盖 ABI 报告、消费者示例、安全测试、性能基线、SBOM、iOS/Android/Windows 平台验证和 OrzMusic 升级流程文档。
